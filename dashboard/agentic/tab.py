"""
Streamlit UI wiring for the Agentic Automation Pipeline Tab.

This module contains ONLY the main render entry-point and all st.* layout/UI
calls.  Business logic helpers are in sibling modules:

- steps.py        -- _check_calibration_quality, _acquire_frames, _scan_dataset_dir,
                     _load_csv_spectrum, _sync_to_project_store, _step_badge
- lspr_physics.py -- _simulate_frame, _preprocess, _store_ref_fwhm
- visualizations.py -- pure chart builders (return go.Figure)
"""
...
from dashboard.agentic.steps import (
    _check_calibration_quality,
    _acquire_frames,
    _scan_dataset_dir,
    _load_csv_spectrum,
    _step_badge,
    _sync_to_project_store,
)
from dashboard.agentic.lspr_physics import (
    _simulate_frame,
    _preprocess,
    _store_ref_fwhm,
)

def render_agentic_pipeline_tab() -> None:
